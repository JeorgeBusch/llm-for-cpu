...
# Example for cache replacement, default is LRUP, refer to caches.py for more info
system.cpu.icache.replacement_policy = LRUP()
system.cpu.dcache.replacement_policy = LRUP()
system.l2cache.replacement_policy = LRUP()
