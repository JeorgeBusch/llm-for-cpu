set -gx CONDA_EXE "/scratch/user/averyjohnson/clone/llm-for-cpu/tools/miniconda/bin/conda"
set _CONDA_ROOT "/scratch/user/averyjohnson/clone/llm-for-cpu/tools/miniconda"
set _CONDA_EXE "/scratch/user/averyjohnson/clone/llm-for-cpu/tools/miniconda/bin/conda"
set -gx CONDA_PYTHON_EXE "/scratch/user/averyjohnson/clone/llm-for-cpu/tools/miniconda/bin/python"
